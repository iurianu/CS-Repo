...
jQuery(document).ready(function( $ ) {
    ...
    //$('body').bsgdprcookies();    
    $('body').append('<aside id="cookie-cog"><a href="#" rel="tag" title="Apasă pentru a modifica setările Cookie" data-toggle="tooltip" data-placement="left"><img src="./assets/images/cog-2.png"></a></aside>'); 
...
(function($) {
    ...
    $.fn.bsgdprcookies = function(options, event) {
        ...
        if(!cookieShow || !cookiePreferences || event == 'reinit') {
            ...
            var modal = '<div class="modal fade ' + settings.class + '" id="' + settings.id + '" tabindex="-1" role="dialog" aria-labelledby="' + settings.id + '-title" aria-hidden="true"><div class="modal-dialog modal-dialog-centered modal-extended" role="document"><div class="modal-content"><div class="modal-header"><h5 class="modal-title" id="' + settings.id + '-title">' + settings.title + '</h5></div><div id="' + settings.id + '-body" class="modal-body" ' + modalBodyStyle + '>' + modalBody + '</div><div class="modal-footer">' + modalButtons + '</div></div></div></div>';
